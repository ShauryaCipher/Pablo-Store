...
const productNamesMap: Record<string, string> = {
    ...
    "p2": "Spacify Web Hoodie",
    "p3": "Puffed Blue Hoodie",
    ...
    "p10": "Denim Venom Hoodie",
    "p11": "One Piece Sweatshirt",
    "p12": "Charcoal Washed Hoodie",
    "p13": "Goofy Hoodie",
    "p14": "Hooded Windsheeter",
    "p15": "Tie-Dye Sweatshirt",
    "p16": "Peanuts Social Club Tee",
    "p17": "Tan Essentials Tee",
    "p18": "Light Creamed Jeans",
    "p19": "Drippy Drip Tee",
    "p20": "Micky Gradient Tee",
    ...
    "p42": "Blue Jeans",
    "p43": "Navy Leather Jacket",
    "p44": "Denim Over Jacket",
    ...
    "p57": "Long Teddy Coat",
    "p58": "Long Brown Teddy Overcoat",
    "p59": "Blue Puffer Jacket",
    "p60": "Olive Fur-Lined Parka",
    "p61": "Wollen Shrug",
